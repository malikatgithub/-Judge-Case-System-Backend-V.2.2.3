...
<div class="container-fuild">
        ...
        <div class="row justify-content-center">
                <div class="col-md-12 text-right" >
                    <div class="card bg-danger text-white p-5 rounded-lg">
                        ...
                        <p class="text-secondary text-left bottom-0"> Accountig Software System - SMS made by: <a href="http://www.privilege.sd" target="_blank" class="text-white font-weight-bold" style="font-size: 11px; letter-spacing:2px">
                        <i class="fab fa-product-hunt text-danger"></i> PRIVILEGE</a></p> 
                    </div>
