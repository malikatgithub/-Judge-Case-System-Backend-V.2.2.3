    ...
    <div class=" pt-5">
        ...
        <div class='cash_container'>
            ...
            <table class='table_cash'>
                ...
                <tr>
                    <td> 
                        </strong> - وصلني من ولي أمر الطالب : <ins> <strong>{{$name}} </ins> <span class=" float-left"> مبلغ و قدرة : <strong> ## {{$invoice_info->paid}} جنية ##</strong></span>
                    </td>
                </tr>
                    ...
                    <td> - وذلك عبارة &nbsp;<ins><strong>   
                                ...
                                {{--Start Function to get the name of fee --}}
                                        ...
                                        @foreach ($fees_types as $names)
                                                @if ($invoice_info->fees_types_id == $names->id)
                                                {{$names->name}}
                                                @else
