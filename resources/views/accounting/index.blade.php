                   ...
                   {{-- End of Session parameter Success and fail or Error --}}
                    ...
                    <div class="card-header border-top1">
                        <h6 class="font-weight-bold"> 
                                <i class="fas fa-cash-register text-muted"></i>&nbsp; بيانات انواع الاقساط

                                <span class="float-left">
                                        <a href="{{url('fees_type/create')}}" class="btn btn-info text-white">  <i class="fas fa-plus-circle fa-1x ml-1" ></i>  إضافة قسط </a>
                                </span>
