                ...
                <div class="card">
                    ...
                    <div class="card-header border-top1">
                        <h5 class="font-weight-bold"> 
                                ...
                                <i class="fas fa-list-ul text-muted"></i>&nbsp; بيانات الموظفين

                                <span class="float-left">
                                        <a href="{{url('employee/create')}}" class="btn bg-success text-white">  <i class="fas fa-plus-circle fa-1x ml-1" ></i> إضافة موظف</a>
                                </span>
