...
class feesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $invoice_info = DB::select(" SELECT * FROM fees WHERE fees_types_id = $fees_type_id AND reg_no = $reg_no AND deleted_at = NULL;");
        ...
        // ======== End of Parameter for Function for check invoice to prevent the redendance 
            ...
            $invoice_info = Fees::where('bill_no', $new_bill_no)->get();
    ...
    public function destroy($id)
    {
        ...
        return back()->with('delete', ' تم مسح بيانات القسط يمكنك مراجعه سلة المهملات !!.');
    }
}
