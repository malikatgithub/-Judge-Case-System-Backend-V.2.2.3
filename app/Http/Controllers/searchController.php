        ...
        if ($request->ajax()) {
            ...
            <tr>
             ...
             <td class='text-center'>
                ...
                <abbr title='Restore Student Information'><a onclick='return studentTrashed()' href='student/restore/$row->id'><i class='fas fa-recycle fa-2x  pt-2 i text-success font-weight-bold ml-1' ></i></a></abbr>
             </td>
            </tr>
            ";
                }
    ...
    public function class_trashed(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            <tr>
             ...
             <abbr title='Restore Teacher Information'><a onclick='return classTrashed()' href='restore/$row->id' ><i class='fas fa-recycle fa-2x  pt-2 i text-success font-weight-bold ml-1' ></i></a></abbr>
    ...
    public function fees_edit_search(Request $request)
    {
        if ($request->ajax()) {
            ...
            <tr>
             ...
             <td class='text-center'>
                <a href='fees/reprint/$row->id' onclick='' class='btn btn-primary text-white' ><i class=' fas fa-print ml-1' ></i>طباعة إيصال</a>
                <a href='fees/edit/$row->id' onclick='return edit()' class='btn btn-success text-white' ><i class=' fas fa-edit ml-1' ></i>تعديل</a>
                <a href='fees/delete/$row->id' onclick='return del()' class='btn btn-danger text-white' ><i class=' fas fa-trash-alt ml-1' ></i>مسح</a>
             </td>
            </tr>
            ";
                }
