...
Route::get('/user', 'studnetsController@user')->name('user');
...
Route::get('lawyer', 'CasesController@lawyer_website')->name('lawyer');
...
Route::post('/case/store', 'CasesController@store')->name('case.store');
Route::post('case/search', 'CasesController@search')->name('case.search');
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::post('cases_search', 'CasesController@cases_search')->name('cases_search');
    Route::post('status.accept/{id}', 'CasesController@update1')->name('status.accept');
    Route::post('status.reject/{id}', 'CasesController@update2')->name('status.reject');


    Route::get('accepted', 'CasesController@accepted')->name('accepted');
    Route::get('rejected', 'CasesController@rejected')->name('rejected');
    Route::get('judge', 'CasesController@judge')->name('judge');
    Route::post('j_comment/{id}', 'CasesController@update')->name('j_comment');

  

    Route::post('reports/{id}', 'CasesController@reports')->name('reports');
    Route::post('notify/{id}', 'CasesController@notify')->name('notify');
    Route::get('notified', 'CasesController@notified_page')->name('notified');

    

    Route::post('print_judge_case/{id}', 'CasesController@print_judge_cases')->name('print_judge_case');
    Route::post('show_judge_case/{id}', 'CasesController@show_judge_cases')->name('show_judge_case');

    


    Route::post('acceptedrollback/{id}', 'CasesController@acceptedrollback')->name('acceptedrollback');
    Route::post('rejectedrollback/{id}', 'CasesController@rejectedrollback')->name('rejectedrollback');



    /* Report View */

    Route::get('adminreports', 'ReportsController@index')->name('adminreports');
    Route::post('accepted_report', 'ReportsController@accepted')->name('accepted_report');
    Route::post('reject_report', 'ReportsController@rejected')->name('reject_report');
    Route::post('judge_report', 'ReportsController@judge')->name('judge_report');


    Route::get('adminshowreports', 'ReportsController@index')->name('adminshowreports');
    
    Route::get('adminprintreports', 'ReportsController@index')->name('adminprintreports');



    Route::get('lawyers', 'CasesController@lawyers')->name('lawyers');
    Route::post('lawyer.store', 'CasesController@lawyer_store')->name('lawyer.store');
    Route::post('lawyer_delete/{id}', 'CasesController@lawyer_delete')->name('lawyer_delete');
...
/*==== Student operation Route ====*/
    ...
    Route::get('/student/restore/{id}', 'studnetsController@restore')->name('student.restore');
...
/*==== Class ====*/
    ...
    Route::get('/class/trashed', 'schoolClassController@classTrashed')->name('class.trashed');
    Route::get('/class/restore/{id}', 'schoolClassController@restore')->name('class.restore');
